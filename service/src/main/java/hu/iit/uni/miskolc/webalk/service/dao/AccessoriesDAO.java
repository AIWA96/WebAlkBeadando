...
public interface AccessoriesDAO {
    ...
    void createAccessories(Accessories accessories) throws StorageNotAvailableException, StorageException, AlreadyExistException, PersistenceException;
    ...
    Collection<Accessories> getAllAccessories() throws StorageNotAvailableException, StorageException, NotFoundException, AlreadyExistException, PersistenceException;

    boolean updateAccessories(Accessories accessories) throws StorageNotAvailableException, StorageException, NotFoundException, AlreadyExistException, PersistenceException;
